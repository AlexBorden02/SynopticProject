...
import green from '../logos/green.jpg';
...
const Mens = () => {
    ...
    return (
		...
		<div class='flex justify-center py-10'>
			<div class='bg-white w-96 shadow-xl rounded px-5 py-5 dark:bg-gray-800 dark:text-gray-800'>
				<img src={green} alt="" className='pb-5 max-h-20'/>
				<form>
					{/* prod type */}
